...
## Git Commits in practice {#github_commits}
...
### Real-world dev cycle for commits
...
## Example of a real-world problem solving in Python : 
...
you can say "here is problem" or you can ask "is this a problem?"  but a PR instead changes  the conversation to  "is this a solution?" which is more efficient
