...
The central feature of most version control system is the "commit" we describe above. nd version control, at it's heart, is a system for software developers to communicate. Understanding the motivation and context of the 'git commit' is key to interpreting a code repository.
