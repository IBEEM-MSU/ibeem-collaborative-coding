...
```{r source, echo=FALSE, out.width= "50%", out.extra='style="float:left; padding:10px"', fig.align="center", fig.cap="[Source](https://blog.codinghorror.com/learn-to-read-the-source-luke/)"} 
