...
Version control systems are an answer to the age-old problem of "script_v1", "script_submitted_to_Science", "script_final", "script_finaler", and "script_final_i_swear_this_is_the_last_one" that tend to clog up and confuse storage space on all of our computers. By tracking changes in a document (in this context, usually a coded script), version control systems allow you to keep a record of all the changes that you have made without having to re-save new documents every time. Version control systems also allow for multiple users to make changes to the same document and keep track of the who-did-what side of things. 
