...
Our 'code' is actually "markdown" which is code that is translated to formatted prose. 
Markdown is a very easy format to learn, very widely used, and we used it for this book.   Github has it's own 'flavor' of markdown (GFM).   Here is a brief introduction to Markdown, please review how to create links using `[]` and `()`   
